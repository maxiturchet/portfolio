...
const Main = () => {
  return (
    <div className="m-auto w-screen h-screen max-w-[1200px] px-[100px] lg:px-[150px]">
      <div className="max-w-[1000px] w-full h-full m-auto  flex justify-center items-center">
        <div>
      ...
      <div className="w-full h-screen  max-[800px]:hidden">
