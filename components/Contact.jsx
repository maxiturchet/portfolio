...
const Contact = () => {
  ...
  return (
    <div id='contact' className="w-full lg:h-screen px-[100px] lg:px-[150px] bg-[url('../public/assets/WorldMap.svg')] bg-no-repeat bg-cover bg-fill bg-center">
      <div className="max-w-[1100px] m-auto w-full pt-10">
        <p className="text-xl text-[#E1DD20] tracking-widest uppercase text-[#E1DD20]">
          Contact
        </p>
        <h2 className="py-8 text-white">Get In Touch</h2>
